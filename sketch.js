...
function setup() {
 ...
 grass = createSprite(401,590,1920,150);
 grass.shapeColor = "green";
  ...
  ground = createSprite(200,516,400,20);
  ground.addImage("ground",groundImage);
  ground.x = ground.width /2;
  
  gameOver = createSprite(670,200);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(670,300);
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(600,495,10,40);
